...
public class Crypter {
    ...
    public static String  writeEncryptDataToFile(String data, File file) {
    ...
    //зчитує зашифровані дані з файла і розшифровує їх
    public static String decryptDataFromFile(File file) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Шифруємо та записуємо дані у файл./nЗашифровані дані : " + writeEncryptDataToFile(data,file));

        System.out.println("Зчитуємо дані з файла та розшифровуємо : ");

        System.out.println(decryptDataFromFile(file));
